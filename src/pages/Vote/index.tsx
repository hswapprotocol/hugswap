...
import { JSBI, TokenAmount, ChainId } from '@src/sdk'
import { shortenAddress, getHecoscanLink } from '../../utils'
          ...
          <RowBetween>
            ...
            {userDelegatee && userDelegatee !== ZERO_ADDRESS ? (
              <RowFixed>
                ...
                <AddressButton>
                  <StyledExternalLink
                    href={getHecoscanLink(ChainId.HECO_MAINNET, userDelegatee, 'address')}
                    style={{ margin: '0 4px' }}
                  >
