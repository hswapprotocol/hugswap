...
import { abi as IUniswapV2Router02ABI } from '@src/assets/json/IUniswapV2Router02.json'
import { ROUTER_ADDRESS } from '../constants'
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from '@src/sdk'
...
export function formatDollarAmount (num:any, digits:any): string{
...
export function formattedNum (number:any, usd = false, acceptNegatives = false): any{
...
export async function getBlocksFromTimestamps(timestamps: any, skipCount = 500) {
  ...
  if (fetchedData) {
    for (var t in fetchedData) {
      if (typeof t === 'string' && fetchedData.hasOwnProperty(t)) {
