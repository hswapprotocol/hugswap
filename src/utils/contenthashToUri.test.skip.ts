...
describe('#contenthashToUri', () => {
  it('1inch.tokens.ht contenthash', () => {
  ...
  it('uniswap.ht contenthash', () => {
    expect(contenthashToUri('0xe5010170000f6170702e756e69737761702e6f7267')).toEqual('ipns://app.hugswap.com')
  })
})
