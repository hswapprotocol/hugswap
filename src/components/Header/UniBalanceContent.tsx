  ...
  return (
    <ContentWrapper gap="lg">
      <ModalUpper>
        ...
        <CardSection gap="md">
          <RowBetween>
            <TYPE.white color="white">{t('Your UNI Breakdown')}</TYPE.white>
        ...
        <CardSection gap="sm">
          <AutoColumn gap="md">
            <RowBetween>
              <TYPE.white color="white">{t('UNI price')}:</TYPE.white>
              <TYPE.white color="white">${uniPrice?.toFixed(2) ?? '-'}</TYPE.white>
            </RowBetween>
            <RowBetween>
              <TYPE.white color="white">{t('UNI in circulation')}:</TYPE.white>
            ...
            {uni && uni.chainId === ChainId.HECO_MAINNET ? (
              <ExternalLink href={`https://info.hugswap.com/token/${uni.address}`}>{t('View UNI Analytics')}</ExternalLink>
            ) : null}
          </AutoColumn>
        </CardSection>
      </ModalUpper>
